...
RM_IHPSG13_2P_1024x16_c2_bm_bist _TECHMAP_REPLACE_ (
    ...
    .A_BIST_REN(1'b0), .A_BIST_ADDR(10'b0), .A_BIST_DIN(16'b0), .A_BIST_BM(16'b0),
    ...
    .B_BIST_REN(1'b0), .B_BIST_ADDR(10'b0), .B_BIST_DIN(16'b0), .B_BIST_BM(16'b0)
);
endmodule
