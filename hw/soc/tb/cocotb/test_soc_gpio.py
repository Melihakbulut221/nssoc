...
from peripheral_registers import GPIO as _REG_OFFSETS
...
OUTPUT = _REG_OFFSETS['OUTPUT']
DIRECTION = _REG_OFFSETS['DIR']
IMASK = _REG_OFFSETS['IMASK']
IPOL = _REG_OFFSETS['IPOL']
IEDGE = _REG_OFFSETS['IEDGE']
BYPASS = _REG_OFFSETS['BYPASS']
CAP = _REG_OFFSETS['CAP']
IRQMAP0 = 0x020
IAVAIL = _REG_OFFSETS['IAVAIL']
IFLAG = _REG_OFFSETS['IFLAG']
IPEN = 0x048
PULSE = 0x04C
IPEN_OR = 0x050
OUTPUT_OR, DIRECTION_OR, IMASK_OR = _REG_OFFSETS['OUTPUT_OR'], _REG_OFFSETS['DIR_OR'], _REG_OFFSETS['IMASK_OR']
IPEN_AND = 0x060
OUTPUT_AND, DIRECTION_AND, IMASK_AND = _REG_OFFSETS['OUTPUT_AND'], _REG_OFFSETS['DIR_AND'], _REG_OFFSETS['IMASK_AND']
IPEN_XOR = 0x070
OUTPUT_XOR, DIRECTION_XOR, IMASK_XOR = _REG_OFFSETS['OUTPUT_XOR'], _REG_OFFSETS['DIR_XOR'], _REG_OFFSETS['IMASK_XOR']
