...
from peripheral_registers import SCRUB as _REG_OFFSETS

STATUS = _REG_OFFSETS['STATUS']
IRQEN = _REG_OFFSETS['IRQEN']
CNT_RAMSEC = _REG_OFFSETS['RAMSEC']
CNT_RAMRD = _REG_OFFSETS['RAMRD']
CNT_RAMDED = _REG_OFFSETS['RAMDED']
CNT_ROMSEC = _REG_OFFSETS['ROMSEC']
CNT_ROMRD = _REG_OFFSETS['ROMRD']
CNT_ROMDED = _REG_OFFSETS['ROMDED']
CLR = _REG_OFFSETS['CLR']
CTRL = _REG_OFFSETS['CTRL']
RAMADDR = _REG_OFFSETS['RAMADDR']
ROMADDR = _REG_OFFSETS['ROMADDR']
