...
"""Prove restricted buffer/sizing/pin-permutation ECO equations from real netlists.
...
from eco_logic import compare, standard_models
...
def main():
    ...
    result.update(status='PASS within scope', yosys_version=version, sources=expected,
                  scope=('Retained cell input equations and state definitions; verified positive buffer '
                         'contraction and Boolean pin permutations. Unchanged opaque masters require '
