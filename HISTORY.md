# README history through 20 September 2026

This archive preserves the previous README, including corrections and withdrawn
claims. It is a historical record, not the current product status. Start with
[README.md](README.md) and [the acceptance register](docs/92-product-acceptance.md).

<!-- archived-readme:start -->
...
count without changing one tracked file: this machine collected **543**
on 2026-09-17 and **584** on 2026-09-18, one day and no synthesis run
apart, where a clone of the same commit collects fewer still. The other four
...
`83858e260194ea4b4a96256443ddb2cdcab05d15`.
