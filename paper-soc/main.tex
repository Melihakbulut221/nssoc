...
% The "what it states" column was 5.6 cm on a 15.9 cm text block, which
% left three centimetres unused and wrapped half the rows to three
% lines. The table then overran its float page and dropped its caption
% onto the folio. Widening it is the fix; the total is still inside the
% text block.
\begin{tabular}{L{2.7cm}L{1.7cm}L{7.0cm}rL{2.1cm}}
\toprule
...
The first printing of this paper named three places in the corpus that
still carried a pre-correction figure; those three were corrected on
2026-09-16, and the pre-correction numbers now survive in exactly one
place, the correction record of the document that made it.
