...
| F0d | Recorded, refresh at delivery | Each ledger row names the revision actually tested. Clean `5f99411` local replay: 16 passing gates, zero failures, seven skips; [record](evidence/ci-local-20260920.json). Refresh again for later substantive source changes; bare-clone evidence remains separate. |
