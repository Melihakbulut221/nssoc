...
register-transfer form and historical placed-and-routed candidates. The
\texttt{s83romecc5} baseline meets hold but fails setup and retains antenna
violations; its antenna-repaired successor fails hold. Neither is a fully
verified physical product. The measurements quantify these limitations
and the costs of the implemented mechanisms.
...
\input{chapters/arch}
\input{chapters/npu}
\input{chapters/harden}
\input{chapters/verif}
\input{chapters/phys}
