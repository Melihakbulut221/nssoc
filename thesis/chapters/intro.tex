...
\begin{figure}[tbp]
  ...
  2306.40 by 2075.22\,\si{\um}, that is
  \qty{4786287.408}{\um\squared} (\dcite{59}{section 3.1}). Apart
...
\qty{0.500}{\um} of a macro edge, none in open routing area,
because a LEF obstruction blanket is one shape more than
\qty{10}{\um} wide and ordinary routing beside it violates
...
\code{0 0 1289.28 313.74}\,\si{\um}, frozen at commit
