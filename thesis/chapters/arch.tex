...
\textbf{43{,}634\,$\upmu$m$^2$, $+18.8$\,\%} and \textbf{1.21\,ns} of
...
\begin{tabular}{lrrrr}
\toprule
Configuration & Cells & Flip-flops & Area, $\upmu$m$^2$ & kGE \\
\midrule
...
Lockstep is \textbf{$+309{,}550\,\upmu$m$^2$, $+112$\,\%} over the chosen
...
$+38{,}050.5762\,\upmu$m$^2$ and $+222$ flip-flops (\dcite{43}{}), and the
watchdog is the recovery policy. The core as shipped is \textbf{22{,}338 cells, 2{,}328
flip-flops, 316{,}051.6590\,$\upmu$m$^2$} (\dcite{45}{section 6.2});
...
The obvious argument, area, is the one the record refuses. An honest AHB-Lite cost probe was built and synthesised at \textbf{17{,}154.32\,$\upmu$m$^2$ against
...
target, one gate equivalent $=$ 7.2576\,$\upmu$m$^2$ (\dcite{45}{section 6})
--- the fabric is 868
cells, 55 flip-flops, \textbf{10{,}928.8872\,$\upmu$m$^2$}, 3.96\,\% of the
unprotected core, and the APB bridge 201 cells, 94 flip-flops,
6{,}437.4912\,$\upmu$m$^2$ (\dcite{60}{section 5.2}).
...
$+90{,}618.62\,\upmu$m$^2$. The check pair was designed unplaced and was \textbf{placed and routed on
2026-09-13} in run \code{s83romecc5}, with zero detailed-routing DRC
errors and a die that does not grow by one database unit. The estimate that the die would have to grow by about 200\,$\upmu$m in
$x$ --- made about the single \code{RM\_IHPSG13\_1P\_1024x16} that was
the alternative, 236.80\,$\upmu$m wide against the 60.48\,$\upmu$m
\dcite{61}{}'s floorplan leaves beside each ROM macro --- was
\textbf{superseded on 2026-09-13} and is kept rather than deleted: the
space the check macros needed was vertical, in the pocket the shorter
ROM macro leaves in its own row, so the estimate had measured the wrong
axis. The pair was never its subject; \dcite{67}{section 8} costed the
pair into that pocket from the start.
\end{sloppypar}
...
code at $+491{,}633.62\,\upmu$m$^2$, $+21.88$\,\% of the six-macro area,
with one on every \code{sb} and \code{sh}; one \code{4096x16} for a
(72,64) code over the whole row at $+257{,}608.51\,\upmu$m$^2$,
$+11.46$\,\%, with one on \emph{every} store; and four more
\code{2048x64} at $+1{,}966{,}534.46\,\upmu$m$^2$ to avoid it. That is a design
...
The protection costs \textbf{$+31{,}391.3124\,\upmu$m$^2$, $+4.783$\,\%}
...
costs $+1{,}421.92\,\upmu$m$^2$, $+0.52$\,\% of the core --- the difference
...
added flip-flops} and $+7{,}026.8310\,\upmu$m$^2$. It corrects: 144 of 144 single-bit injections into the 72 stored bits came
...
\dcite{40}{section 9} reports 1{,}038 cells and 16{,}683.48\,$\upmu$m$^2$,
...
replicas of 22, at $+5{,}091.06\,\upmu$m$^2$ and \textbf{1.6\,\% of what
...
fault lines at a further $+4{,}796.1396\,\upmu$m$^2$, which
\dcite{60}{section 5.7} declines to fold in because no run has reported
the sum. The SCRUB row counts more registers than \dcite{60}{section
5.7} does, and both are right on their own dates: that document's
seven-register table is revision 0.1's, and \dcite{55}{} and
\dcite{58}{} later added \code{CNT\_NPUCOR}, \code{CNT\_NPUDET},
\code{CNT\_NPUTMR} and \code{CNT\_MTECC} above \code{CLR}, which keeps
its offset of \code{0x018}.}
\label{tab:arch-slots}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}llp{2.5cm}p{4.3cm}rrr@{}}
\toprule
Slot & Address & Block & Registers & IRQ & Line & Area, $\upmu$m$^2$ \\
\midrule
...
\code{0x015} & \code{0xFF915000} & BUSSTAT & 11, at \code{0x00}--\code{0x28} & 22 & 10 & 7{,}060.55 \\
...
19{,}690.6248\,$\upmu$m$^2$, \textbf{4.2\,\% of the size} of the block it
...
$+5{,}255.9010\,\upmu$m$^2$ and $+51$ flip-flops; placed and routed
...
5{,}833 flip-flops, 687{,}776.3676\,$\upmu$m$^2$} of standard cells plus
...
685{,}153.2744\,$\upmu$m$^2$} (\dcite{69}{section 7.4},
