...
errors and a die that does not grow by one database unit. The estimate that the die would have to grow by about 200\,$\mu$m in
$x$ --- made about the single \code{RM\_IHPSG13\_1P\_1024x16} that was
the alternative, 236.80\,$\mu$m wide against the 60.48\,$\mu$m
...
and append to the caption of \cref{tab:arch-slots}: \dcite{60}{section
5.7}'s seven-register table is revision 0.1's; \dcite{55}{} and
\dcite{58}{} added \code{CNT\_NPUCOR}, \code{CNT\_NPUDET},
