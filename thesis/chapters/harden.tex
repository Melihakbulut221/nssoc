...
\code{mtimecmp}, ``roughly 27{,}000\,$\upmu$m$^2$ \dots\ 256
more flip-flops'', measured at 25{,}792.0740\,$\upmu$m$^2$
...
faulty one --- truncation saves 1{,}438.1766\,$\upmu$m$^2$ and
...
+491{,}633.62\,$\upmu$m$^2$ or
+257{,}608.51\,$\upmu$m$^2$ \emph{and} a read-modify-write on
...
cost \textbf{one flip-flop} and +643.0536\,$\upmu$m$^2$ on
...
3.78\,$\upmu$m centre-to-centre, the floor for two cells in
...
27.52\,$\upmu$m against 113.47\,$\upmu$m over all
...
7.2576\,$\upmu$m$^2$; the Ibex reference is
275{,}682.6198\,$\upmu$m$^2$. Deltas are arithmetic on two
...
\begin{tabular}{@{}lrrr@{}}
\toprule
Mechanism & $\Delta$ flops & $\Delta$ area ($\upmu$m$^2$) & of Ibex \\
\midrule
...
58.17\,$\upmu$m$^2$, 25.4394\,$\upmu$m$^2$
and 10.9242\,$\upmu$m$^2$, the last in the direction that
...
standalone delta is +31{,}709.55\,$\upmu$m$^2$ against a
whole-core +38{,}050.58\,$\upmu$m$^2$, \SI{20}{\percent}
...
\dcite{67}{section 5.1} puts at +26{,}932.9914\,$\upmu$m$^2$ and $+211$
flip-flops.
...
+1{,}201.5486\,$\upmu$m$^2$ (\dcite{44}{\,5.4}), and
