...
Dominant violating launch group & the register-file read into the fabric & \code{docs/72}, \code{docs/73} \\
\midrule
...
register-file read into the fabric, whose structural answer --- a
registered request phase --- remains unpriced. Worse, the 61 new
