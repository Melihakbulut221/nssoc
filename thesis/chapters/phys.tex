...
37,895 cells of \qty{523809.6444}{\um\squared} against 27,565 of
\qty{396177.6420}{\um\squared}, and its worst slow-corner path is
...
\begin{figure}[tbp]
  ...
  rows face a \qty{700.08}{\um} standard-cell channel; the
...
The die is $2306.40 \times 2075.22$\,\si{\um}, reported as
\qty{4786290}{\um\squared} and exactly
\qty{4786287.408}{\um\squared} as the product of the DEF's own
\code{DIEAREA} corners (\dcite{59}{section 4.1}). The core runs from
$(60.00,\,45.36)$ to $(2246.40,\,2029.86)$\,\si{\um}:
$2186.40 \times 1984.50$\,\si{\um} and
\qty{4338910}{\um\squared}. Alignment is asserted rather than
arranged --- \num{2186.40} is exactly 4,555 sites of
\qty{0.48}{\um} and \num{1984.50} exactly 525 rows of
\qty{3.78}{\um}, and every macro origin is an integer number of
...
\begin{tabular}{@{}llrrl@{}}
\toprule
\textbf{Instance} & \textbf{Master} & \textbf{$W \times H$, \si{\um}} & \textbf{Origin, \si{\um}} & \textbf{Orient} \\
\midrule
...
\emph{bottom}; and both face the \qty{700.08}{\um} channel
...
item read that there was \qty{60.48}{\um} beside each ROM and
the check part is \num{236.80} wide --- true, and a measurement of the
wrong axis. A macro row is as tall as the RAM,
\qty{626.70}{\um}; the ROM is \num{336.46}; the third column
therefore carries \qty{290.24}{\um} of unused height per row
...
clearances are \qty{95.94}{\um} and \qty{98.24}{\um}
with a \qty{10}{\um} halo, computed from the LEF size and row
...
Standard-cell area, \si{\um\squared} & 933{,}010 \\
Macro area, \si{\um\squared} & 2{,}337{,}520 \\
Rows / sites & 1{,}517 / 1{,}003{,}595 \\
Instance utilisation & 0.7538 \\
Standard-cell utilisation & 0.4662 \\
Legalisation displacement, mean / max, \si{\um} & 0.075 / 20.04 \\
\bottomrule
\end{tabular}
\end{table}
...
\qty{2001390}{\um\squared}, of which the standard cells fill
...
SoC put \qty{396177.6420}{\um\squared} of cells into
\qty{2092010.95}{\um\squared} (\dcite{48}{section 4.1}),
...
net is \qty{4292.89}{\um}. And the Classic flow has no
...
\qty{62}{\um} across and \qty{552}{\um} up, over a
\qty{336}{\um} macro, at a \qty{4.69}{\nano\second} transition
...
route}: the fence takes \qty{38102}{\um\squared} of placeable
...
\item \textbf{Magic DRC}, macros entering as LEF abstracts: 170 error
  ...
  \emph{every one of the 150 lies within \qty{0.5}{\um} of a
  macro edge}, none further and none in open routing area. A LEF
  obstruction blanket is one shape more than \qty{10}{\um}
...
\qty{7618.97}{\um\squared}, and does not route --- its layout
...
\qty{27.52}{\um} against \qty{113.47}{\um} over all
